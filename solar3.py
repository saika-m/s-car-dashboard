...
solar = SolarCar(get_speed, get_pos, gps_dim, get_touch_sensor, 2.153412, get_temp, live_video, serial_ports=['/dev/ttyUSB0', '/dev/ttyUSB1'], baud_rate=19200)  # Pass video_widget as an argument
solar.start_loop()
