...
class SolarCar(object):
    def __init__(self,
                 ...
                 one_cycle_len: float,
                 get_temp: Callable,
                 live_video: Callable):  # Pass the VideoWidget instance
...
solar = SolarCar(get_speed, get_pos, gps_dim, get_touch_sensor, 2.153412, get_temp, live_video)  # Pass video_widget as an argument
solar.start_loop()
